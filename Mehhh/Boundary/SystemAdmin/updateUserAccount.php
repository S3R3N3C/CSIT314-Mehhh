...
$id = $user_fullname = $username = $password = $user_profile = "";
...
if (isset($_POST['update'])) {
    ...
    if (empty($usernameError) && empty($passwordError)) {
        ...
        $result = $updateUserAccountController->updateUserAccount($id, $user_fullname,$username, $password, $user_profile);
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-success panel-size-custom">
                            ...
                            <div class="panel-body">
                                <form action="updateUserAccount.php" method="post" id="updateUserForm">
                                    <div class="form-group">
                                        ...
                                        <select name="user_profile" id="user_profile" class="form-control">
                                            <option value="System Admin" <?php if ($user_profile == 'System Admin') echo 'selected'; ?>>System Admin</option>
                                            <option value="Real Estate Agent" <?php if ($user_profile == 'Real Estate Agent') echo 'selected'; ?>>Real Estate Agent</option>
                                            <option value="Seller" <?php if ($user_profile == 'Seller') echo 'selected'; ?>>Seller</option>
                                            <option value="Buyer" <?php if ($user_profile == 'Buyer') echo 'selected'; ?>>Buyer</option>
                                        </select>
                                    </div>
                                    <br>
                                    <div class="form-group">
