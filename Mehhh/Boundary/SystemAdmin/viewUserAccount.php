            ...
            <tbody>
                <?php foreach ($userAccount as $user) { ?>
                    <tr>
                        ...
                        <td><?php echo $user['user_profile']; ?></td>
                        ...
                        <td>
                            ...
                            <a href="activateUserAccount.php?user_id=<?php echo $user['user_id']; ?>&activate_success=true" onClick="return confirm('Are you sure you want to activate?')">Activate</a> |
                            <a href="deleteUserAccount.php?user_id=<?php echo $user['user_id']; ?>&delete_success=true" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
