...
class UserAccount
{
    ...
    public function loginAccount($username, $password):bool
    {
        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($_SESSION['user_profile'] == 'System Admin') {
                header('location: ../../Boundary/SystemAdmin/userProfile.php'); // default page: userProfile
            } 
            ...
            // Buyer
            elseif ($_SESSION['user_profile'] == 'Buyer') {
    ...
    // Method 1: Get all user accounts
    ...
    // 2. Add user account
    public function addUserAccount($user_fullname, $username, $password, $user_profile):bool
    {
        $conn = mysqli_connect(HOST, USER, PASS, DB);
