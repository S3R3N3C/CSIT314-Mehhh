...
if (isset($_GET['property_id'])) {
    ...
    .property-details {
        padding-top: 20px;
        font-size: 25px; /* Increase font size for property details */
    }

    .property-details p {
        margin-bottom: 10px; /* Add spacing between property details */
    }
            ...
            <div class="property-container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div style="height: 450px; width: 450px; overflow: hidden;">
