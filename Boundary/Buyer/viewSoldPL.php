<?php
include_once("../../Controller/Buyer/viewSoldPLController.php");
include_once("../../Controller/Buyer/addFavListController.php");

$buyer_id = $_SESSION['buyer_id'];
$viewSoldPLController = new viewSoldPLController();
$propertyListings = $viewSoldPLController->viewSoldPL();
...
if (isset($_GET['property_id'])) {
  ...
  $viewSoldPLController->incrementNoOfShort($property_id);
...
if (isset($_POST['search'])) {
  ...
  if (!empty($search)) {
      ...
      include_once("../../Controller/Buyer/searchSoldPLController.php");
      $searchSoldPLController = new searchSoldPLController();
      $propertyListings = $searchSoldPLController->searchSoldPL($search);
  } else {
...
<section>
  <h3 style="text-align: center;">Sold Property</h3>
</section>
...
<section>
  <section id="search-container">
        <form id="searchForm" action="" method="post" class="search-form">
            ...
            <button type="reset" id="backToListing" onclick="window.location.href='viewSoldPL.php'">Back</button>
        </form>
    </section>
    <br>
    <section>
