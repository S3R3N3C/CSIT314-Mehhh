...
if (isset($_GET['property_id'])) {
  ...
  $viewPropertyListingsController->incrementNoOfShort($property_id);
...
// Update $propertyListings array to include whether each property is in the favorite list
...
if (isset($_POST['search'])) {
  ...
  if (!empty($search)) {
      ...
      include_once("../../Controller/Buyer/searchPropertyListingController.php");
