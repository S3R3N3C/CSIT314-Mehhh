...
include_once("../../Controller/Seller/viewAgentReviewController.php");
include_once("../../Controller/Seller/viewAgentRatingController.php");
...
<body>
    ...
    <br>
    <button style="background-color: yellow" onclick="window.location.href='viewAgents.php'"><b>Back</b></button>
